...
export default function Footer() {
  return (
    <footer className="border-t border-neutral-800 bg-black">
      {/* Desktop */}
      <div className="hidden h-[120px] items-center justify-between px-[140px] py-2 md:flex">
      ...
      {/* Mobile */}
      <div className="flex h-[120px] items-center justify-between px-4 md:hidden">
        <div className="flex items-center gap-1.5">
          <Tv className="h-7 w-7 text-brand" />
          <span className="text-neutral-25 text-lg font-semibold tracking-[-0.5px]">Movie</span>
        </div>
        <p className="text-sm text-neutral-600">Copyright &copy;2025 Movie Explorer</p>
      </div>
    </footer>
  );
}
